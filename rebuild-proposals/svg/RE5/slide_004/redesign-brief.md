...
- Archetyp: dual-planning
- Lernbotschaft: Reproduzierbare Versuche verbinden praktische Prüfplanung mit statistischer Auslegung.
- Titelbehandlung: kein sichtbarer globaler Titel; Downstream-System ergänzt Titel, Regel, Footer, Logo und Szenenkennung.
- Inhaltsäquivalenz: Begriffe, Zahlen, Formeln, Plotbeziehungen und fachliche Zustände der Quellen 4 bleiben in der Zielkomposition erhalten.
- Spezialpfade: Plot=none; Formeln=keine; neue Piktogramme=keine.
...
- Animation: animated umgesetzt; semantische Gruppen=technical_planning, statistical_planning, shared_outcome.
