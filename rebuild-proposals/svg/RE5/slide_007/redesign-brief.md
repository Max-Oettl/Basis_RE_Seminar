...
- Archetyp: definition
- Lernbotschaft: Ein Nachweis zeigt, dass die Produktzuverlässigkeit oberhalb der geforderten Grenze liegt.
- Titelbehandlung: kein sichtbarer globaler Titel; Downstream-System ergänzt Titel, Regel, Footer, Logo und Szenenkennung.
- Inhaltsäquivalenz: Begriffe, Zahlen, Formeln, Plotbeziehungen und fachliche Zustände der Quellen 7 bleiben in der Zielkomposition erhalten.
...
- Animation: static umgesetzt; semantische Gruppen=keine.
