...
- Zielszene: slide_055
- Modus: full_slide
- Quell-SVGs: Folie70.SVG
- Sprechertext: analysis/source-text/RE1/extracted/12_Modul_Einfuehrung_ZUV - Exponentialverteilung.md

## Lernbotschaft

Ein Parameter hält alle Beziehungen überschaubar.

## Archetyp Und Komposition

- Archetyp: Vierzeilige Formelmatrix
...
Parameter; f(t); F(t); R(t); λ(t); Anwendungsfolgerung.

## QA-Schwerpunkte

- vollständiger Inhaltstransfer gegen Folie70.SVG
