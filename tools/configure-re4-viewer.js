...
const { SCENES, SOURCE_STATE_COUNT } = require("./re4-redesign-spec");
...
function main() {
  ...
  process.stdout.write(`Configured RE4 viewer: ${active.size} active scenes, ${SOURCE_STATE_COUNT - active.size} hidden source states.\n`);
}
