...
const SCENES = Object.freeze([
  ...
  scene(55, [55, 56, 57], "section_007", "Separation vorbereiten", "Die Brückenschaltung wird durch die isolierte Betrachtung von Komponente 5 berechenbar.", "method-introduction", "bridge_separation", { notes: "Review-Korrektur: Die Einordnung bildet eine eigene, ruhige Szene mit drei stabilen Typostufen. Die kanonische Fünf-Komponenten-Brücke bleibt groß; Komponente 5 wird als Schlüsselkomponente fokussiert." }),
  scene(58, [58, 59, 60], "section_007", "Separationsfälle berechnen", "Die beiden disjunkten Zustände von Komponente 5 ergeben berechenbare Ersatzstrukturen, deren Teilzuverlässigkeiten addiert werden.", "formula-comparison", "bridge_separation_cases", { primary: 60, notes: "Review-Korrektur: Fall I und Fall II erhalten eine eigene Rechenszene mit großen Ersatzstrukturen, Fallgewichten, kontrollierten Formelassets und vollständiger Endsumme." }),
