...
Generated: 2026-07-20T05:35:15.597Z
...
- WARNING [group_integrity] (rebuild-proposals/svg/RE1/slide_064/plots/weibull_paper.svg): t=0s No data-qc-* attributes found; layout QA is using heuristics only. Recommendation: Add data-qc-role, data-qc-box, data-qc-group, and data-qc-layer to newly generated SVGs.
- WARNING [unexpected_overlap] (rebuild-proposals/svg/RE1/slide_064/plots/weibull_paper.svg): t=0s element=qc_runtime_30 related=qc_runtime_243 Important elements overlap without an explicit data-qc-allow-overlap exception. Recommendation: Move one element, add wrapping, or mark the intentional overlap with data-qc-allow-overlap="true".
- WARNING [unexpected_overlap] (rebuild-proposals/svg/RE1/slide_064/plots/weibull_paper.svg): t=0s element=qc_runtime_339 related=qc_runtime_347 Important elements overlap without an explicit data-qc-allow-overlap exception. Recommendation: Move one element, add wrapping, or mark the intentional overlap with data-qc-allow-overlap="true".
- WARNING [unexpected_overlap] (rebuild-proposals/svg/RE1/slide_064/plots/weibull_paper.svg): t=0s element=qc_runtime_385 related=qc_runtime_387 Important elements overlap without an explicit data-qc-allow-overlap exception. Recommendation: Move one element, add wrapping, or mark the intentional overlap with data-qc-allow-overlap="true".
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=0s element=qc_runtime_480 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=0s element=qc_runtime_481 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=0.533s element=qc_runtime_480 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=0.533s element=qc_runtime_481 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=1.517s element=qc_runtime_480 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=1.517s element=qc_runtime_481 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=3.367s element=qc_runtime_480 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=3.367s element=qc_runtime_481 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=5.217s element=qc_runtime_480 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=5.217s element=qc_runtime_481 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=6.2s element=qc_runtime_480 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
- WARNING [text_inside_box] (rebuild-proposals/svg/RE1/slide_064/slide_064.svg): t=6.2s element=qc_runtime_481 related=qc_runtime_463 Text does not fit inside its background box (right). Recommendation: Box enlarge, text wrap, or move text so visible padding remains on every side.
...
- slide 64: svg=true, animation=true, steps=5, file=slide_064.svg
