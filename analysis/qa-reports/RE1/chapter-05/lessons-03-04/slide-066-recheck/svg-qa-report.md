...
Generated: 2026-07-20T05:48:08.768Z
...
- WARNING [group_integrity] (rebuild-proposals/svg/RE1/slide_066/plots/nkw_probability.svg): t=0s No data-qc-* attributes found; layout QA is using heuristics only. Recommendation: Add data-qc-role, data-qc-box, data-qc-group, and data-qc-layer to newly generated SVGs.
- WARNING [unexpected_overlap] (rebuild-proposals/svg/RE1/slide_066/plots/nkw_probability.svg): t=0s element=qc_runtime_312 related=qc_runtime_320 Important elements overlap without an explicit data-qc-allow-overlap exception. Recommendation: Move one element, add wrapping, or mark the intentional overlap with data-qc-allow-overlap="true".
- WARNING [unexpected_overlap] (rebuild-proposals/svg/RE1/slide_066/plots/nkw_probability.svg): t=0s element=qc_runtime_358 related=qc_runtime_360 Important elements overlap without an explicit data-qc-allow-overlap exception. Recommendation: Move one element, add wrapping, or mark the intentional overlap with data-qc-allow-overlap="true".
- WARNING [layout_browser_render] (rebuild-proposals/svg/RE1/slide_066/slide_066.svg): SVG layout QA failed for this file. Recommendation: Check SVG syntax, external references, and browser-renderability.
