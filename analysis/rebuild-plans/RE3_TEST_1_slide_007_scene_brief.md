...
- source_slides: 7
- output_svg: rebuild-proposals/svg/RE3_TEST_1/slide_007/slide_007.svg
- animation_manifest: rebuild-proposals/svg/RE3_TEST_1/slide_007/scene.animation.v1.json
...
- source state: Weibull-Funktion mit Beispielwert
- targets: input_timeline, tool_transform, weibull_context_plot, formula_panel, weibull_formula_inline, example_value
