...
- source_slides: 8
- output_svg: rebuild-proposals/svg/RE3_TEST_1/slide_008/slide_008.svg
- animation_manifest: rebuild-proposals/svg/RE3_TEST_1/slide_008/scene.animation.v1.json
...
- source state: Übergangszustand per Fade
- targets: transition_only_state
