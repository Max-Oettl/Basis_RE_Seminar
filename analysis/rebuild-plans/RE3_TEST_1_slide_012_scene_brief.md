...
- source_slides: 12
- output_svg: rebuild-proposals/svg/RE3_TEST_1/slide_012/slide_012.svg
- animation_manifest: rebuild-proposals/svg/RE3_TEST_1/slide_012/scene.animation.v1.json
...
- source state: Methoden einordnen
- targets: weibull_context_plot, methods_arrow, methods_box
