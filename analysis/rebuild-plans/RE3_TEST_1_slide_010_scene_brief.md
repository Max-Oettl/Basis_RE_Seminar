...
- source_slides: 10
- output_svg: rebuild-proposals/svg/RE3_TEST_1/slide_010/slide_010.svg
- animation_manifest: rebuild-proposals/svg/RE3_TEST_1/slide_010/scene.animation.v1.json
...
- source state: Ausfälle Objekt-Nummern zuordnen
- targets: weibull_context_plot, assignment_arrow, object_time_plot, assignment_note
