...
- source_slides: 11
- output_svg: rebuild-proposals/svg/RE3_TEST_1/slide_011/slide_011.svg
- animation_manifest: rebuild-proposals/svg/RE3_TEST_1/slide_011/scene.animation.v1.json
...
- source state: Zensierte Beobachtungen ergänzen
- targets: weibull_context_plot, censoring_arrow, object_time_plot, censoring_note
