...
- Neue oder grundlegend ueberarbeitete SVGs verwenden `brandProfile=reltest-education`, Signalgruen `#00A754` als primaeren Education-Akzent, Oxanium fuer Headlines/Auszeichnungen und Archivo fuer Fliesstext, Labels und Captions. Solutions-Cyan `#0C84B4` bleibt in Education-Inhalten eine definierte Diagrammfarbe, nicht der fuehrende Markenakzent.
