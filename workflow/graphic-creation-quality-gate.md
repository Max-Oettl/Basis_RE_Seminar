...
Ziel ist keine PowerPoint-Folie, sondern ein sauberes Bild- oder Diagrammelement für ein E-Learning-Video. Titel, Kapitelüberschriften und lange erklärende Texte gehören nur dann in die Grafik, wenn sie ausdrücklich Teil des gewünschten Bildes sind.
...
Wichtig: Die Grafik ist nicht die ganze Folie. Sie darf keine automatische PowerPoint-Überschrift bekommen.
...
Technische Diagramme sind Python-first. Achsen, Datenpunkte, Fit-Linien und Wahrscheinlichkeitsnetze werden ueber `components/python-plot-library/` erzeugt, sofern es sich nicht um eine bewusst begruendete einfache Erklaerskizze handelt.
