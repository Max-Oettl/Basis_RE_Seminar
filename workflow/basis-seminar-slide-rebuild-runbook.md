...
12. Rebuild-Entscheidungen fuer Text, SVG und optionale PNG-Assets dokumentieren.
...
Wenn der Nutzer aus der Analyse heraus SVG-Vorschlaege beauftragt, beginnt danach nicht direkt die SVG-Produktion. Zuerst gilt `workflow/svg-rebuild-production-runbook.md`; dort werden Sequenzkarte, finale Zielzustaende, Design-Briefs und Cross-Check-Regeln festgelegt.
...
Solche Sequenzen werden nicht als voneinander unabhaengige Inhaltsfolien behandelt. Im Inventar werden sie als Gruppe markiert:
...
- Diagramme, Tabellen, Prozesspfeile, einfache Marker und Formeln als SVG/Text
